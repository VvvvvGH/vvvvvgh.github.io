...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#E06C75;">    }</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#E06C75;">  }</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="弗拉戈在哪里2" tabindex="-1"><a class="header-anchor" href="#弗拉戈在哪里2"><span>弗拉戈在哪里2?</span></a></h1><p>用strings命令，直接得到flag</p><h1 id="easyrsa" tabindex="-1"><a class="header-anchor" href="#easyrsa"><span>EasyRSA</span></a></h1><p>参考文章 http://www.ruanyifeng.com/blog/2013/07/rsa_algorithm_part_two.html</p><p>因为没有研究过rsa,所以只能follow文章去做。 已知 n e c<br> 把 n 放到 http://factordb.com 上分解，分解成功，得到p q。 e = 0x10001。<br> 用工具计算n 遂得到 m = pow(c, d, n)</p><h1 id="《web安全入门第一课》-《web安全入门第二课》-一段矛盾的代码" tabindex="-1"><a class="header-anchor" href="#《web安全入门第一课》-《web安全入门第二课》-一段矛盾的代码"><span>《web安全入门第一课》 ，《web安全入门第二课》 ，一段矛盾的代码</span></a></h1><p>矛盾的代码，这个虽然不太懂，没接触过PHP，但有了源码就可以搜索相关的问题。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>is_numeric(1a)   FALSE</span></span>
<span class="line"><span>1a == 1          TRUE</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>http://119.29.191.200/ctf/46d3e59de07a6aac6b2078c35aa4c16a03d10df3/?num=1a</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h1 id="重重flag背后隐藏的秘密" tabindex="-1"><a class="header-anchor" href="#重重flag背后隐藏的秘密"><span>重重flag背后隐藏的秘密</span></a></h1><p>正则表达式筛选可以得到答案。</p><h1 id="一张含有信息的图片" tabindex="-1"><a class="header-anchor" href="#一张含有信息的图片"><span>一张含有信息的图片</span></a></h1><p>古时候打仗，友军间通信为了不被敌人发现重要的情报，用了各种各样的方法隐藏信息，延续到了现代，又有了新的变化...</p><p>binwalk发现zlib ， 解压发现exif ，没头绪，放进Photoshop ，调色，发现flag。看到flag内容又get到一个新工具。</p><h1 id="一个简陋的博客" tabindex="-1"><a class="header-anchor" href="#一个简陋的博客"><span>一个简陋的博客</span></a></h1><p>前端的X同学做一半跑路了，反正功能实现了，能上传文章就行（逃。。。</p><p>对前几天才接触CTF的喔来说，这道题一直没有头绪，直到看到了这篇文章 <a href="http://www.lujza.me/%E5%AE%9E%E9%AA%8C%E5%90%A7ctf%E4%B9%8Bweb%E4%B8%93%E9%A2%98-2.html" target="_blank" rel="noopener noreferrer">实验吧CTF之web专题-2</a> 原来是这样的</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>?id=&#39;               FALSE</span></span>
<span class="line"><span>?id=1 &#39;and &#39;1&#39;=&#39;1   TRUE</span></span>
<span class="line"><span>?id=1 &#39;and &#39;1&#39;=&#39;2   FALSE</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>现在可以猜密码了。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>(select count(*) from flag)&gt;0</span></span>
<span class="line"><span>(select flag from flag)&gt; 0</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><p>于是得到flag ，但不知为何，提交说答案错误，后来发现全是小写。所以要注意了。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>flAG{3Q1Map_1S_u3Sfu1}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>代码记录</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>import requests</span></span>
...
<span class="line"><span>            write_csv.writerow(row)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>为了分析的方便，用excel对数据进行处理，重点是上传下载，将相应的行为标记上颜色。 <img src="http://7xkmnm.com1.z0.glb.clouddn.com/xls1.PNG" alt="image" loading="lazy"></p><p>1.6.4@302_111085.exe<br> 打开后没有操作的情况下频繁地对系统文件进行读写操作，未经用户同意释放软件安装包，恶意软件无疑。</p><p>发现一个很可疑的ip <img src="http://7xkmnm.com1.z0.glb.clouddn.com/xls2.PNG" alt="image" loading="lazy"></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>VM-PC:49160 -&gt; 121.43.97.175:http</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>于是打开wireshark输入 ip.addr == 121.43.97.175</p><p>选择该ip以追踪HTTP流，然后就得到了软件的第一次联网数据。</p><p>这段数据是不是看起来很正常呢？ 不是，很明显恶意软件在通过api获取推广软件的下载地址。 既然要做推广必然要标记用户，所以收集用户信息是非常常见的流氓行为。</p><blockquote><p>GET /api.php?id=111085&amp;qid=302&amp;rand=52231541381&amp;flag=328704&amp;title=1.6.4&amp;t=0 HTTP/1.1</p></blockquote><p>这里可以看到软件通过GET请求上传了用户信息，据我猜测，地址信息应该不是ip地址，那应该就是网卡的mac地址了。<br> 转换成十进制 就是rand这个参数没跑了。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>00:0c:29:3e:12:85 </span></span>
<span class="line"><span>52231541381</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><p>这里附上相关的数据和文件</p><p><a href="http://7xkmnm.com1.z0.glb.clouddn.com/output.xls" target="_blank" rel="noopener noreferrer">1.6.4@302_111085.exe 行为</a></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>GET /api.php?id=111085&amp;qid=302&amp;rand=52231541381&amp;flag=328704&amp;title=1.6.4&amp;t=0 HTTP/1.1</span></span>
...
<span class="line"><span>key=D6F776F6F17052CE8B6D4FC861D68994</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,79)]))}const r=n(p,[["render",e],["__file","2017-10-24-ctf.html.vue"]]),v=JSON.parse('{"path":"/posts/2017-10-24-ctf.html","title":"玩玩CTF","lang":"zh-CN","frontmatter":{"title":"玩玩CTF","date":"2017-10-24T00:00:00.000Z","category":["CTF","安全","渗透测试"],"tag":["aaencode","base64","zip","UltraEdit","strings","quipqiup","词频分析"],"description":"Xp0int大家庭 Xp0int日常，跑一下我们在干什么？ 网上搜索发现是 aaencode 所以试试在chrome的console运行。 得到flag 弗拉戈在哪里？ 小明整蛊舍友，将他舍友的兰博基尼钥匙锁在zip里面了，你能帮他找回钥匙吗？ 提示： 在zip里面 1.zip 拖进UltraEdit 搜索flag 发现一段base64，于是解码。应该...","head":[["meta",{"property":"og:url","content":"https://space.vistazx1.top/posts/2017-10-24-ctf.html"}],["meta",{"property":"og:site_name","content":"Vista"}],["meta",{"property":"og:title","content":"玩玩CTF"}],["meta",{"property":"og:description","content":"Xp0int大家庭 Xp0int日常，跑一下我们在干什么？ 网上搜索发现是 aaencode 所以试试在chrome的console运行。 得到flag 弗拉戈在哪里？ 小明整蛊舍友，将他舍友的兰博基尼钥匙锁在zip里面了，你能帮他找回钥匙吗？ 提示： 在zip里面 1.zip 拖进UltraEdit 搜索flag 发现一段base64，于是解码。应该..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"http://7xkmnm.com1.z0.glb.clouddn.com/%E6%88%AA%E5%9B%BE1.PNG"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-09-30T06:20:05.000Z"}],["meta",{"property":"article:tag","content":"aaencode"}],["meta",{"property":"article:tag","content":"base64"}],["meta",{"property":"article:tag","content":"zip"}],["meta",{"property":"article:tag","content":"UltraEdit"}],["meta",{"property":"article:tag","content":"strings"}],["meta",{"property":"article:tag","content":"quipqiup"}],["meta",{"property":"article:tag","content":"词频分析"}],["meta",{"property":"article:published_time","content":"2017-10-24T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-09-30T06:20:05.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"玩玩CTF\\",\\"image\\":[\\"http://7xkmnm.com1.z0.glb.clouddn.com/%E6%88%AA%E5%9B%BE1.PNG\\",\\"http://7xkmnm.com1.z0.glb.clouddn.com/xls1.PNG\\",\\"http://7xkmnm.com1.z0.glb.clouddn.com/xls2.PNG\\"],\\"datePublished\\":\\"2017-10-24T00:00:00.000Z\\",\\"dateModified\\":\\"2024-09-30T06:20:05.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Guohao\\",\\"url\\":\\"https://space.vistazx1.top\\"}]}"]]},"headers":[{"level":2,"title":"报告：","slug":"报告","link":"#报告","children":[]}],"git":{"createdTime":1727677205000,"updatedTime":1727677205000,"contributors":[{"name":"root","email":"root@vistazx1.top","commits":1}]},"readingTime":{"minutes":10.06,"words":3019},"filePathRelative":"posts/2017-10-24-ctf.md","localizedDate":"2017年10月24日","excerpt":"\\n<blockquote>\\n<p>Xp0int日常，跑一下我们在干什么？</p>\\n</blockquote>\\n<p>网上搜索发现是\\naaencode\\n所以试试在chrome的console运行。\\n得到flag</p>\\n<h1>弗拉戈在哪里？</h1>\\n<blockquote>\\n<p>小明整蛊舍友，将他舍友的兰博基尼钥匙锁在zip里面了，你能帮他找回钥匙吗？</p>\\n</blockquote>\\n<p>提示： 在zip里面</p>\\n<p>1.zip 拖进UltraEdit 搜索flag<br>\\n发现一段base64，于是解码。应该也能用strings命令看到base64。</p>\\n<h1>好像说太多了</h1>","autoDesc":true}');export{r as comp,v as data};
